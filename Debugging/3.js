...
/*
The issue is that random method returns an array each time its called
Thus when dishName and dish are created, addition is done betwen 3 seperate arrays
This takes all the values inside the arrays and concatenates them into a long string
Join can't be called on a string
Alternative is to take the 3 arrays and use the concat method on the 1st one with 2nd and 3rd as arguments
This will make dishName and dish larger arrays that can be joined
*/